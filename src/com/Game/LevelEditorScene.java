...
public class LevelEditorScene extends Scene{
    ...
    @Override
    public void init() {
        player = new GameObject("game obj", new Transform(new TwoPair(600.0f, 500.0f)));
    ...
    public void update(double dTime) {
        player.update(dTime);
        player.transform.rotation += dTime * 2f;
        camera.pos.x += dTime * 80f;        //camera moving to right, player is drawn back and forth relative to (0,0)
    }
