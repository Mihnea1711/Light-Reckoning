...
public class Level2Menu extends Scene{
    ...
    public void initButtons() {
        ...
        SceneChangerButton playButton = new SceneChangerButton(levelButtonSprite.width, levelButtonSprite.height, levelButtonSprite, levelButtonSprite, "Deadlocked777", 1);
        levelButton.addComponent(playButton);
        levelButton.setUI(true);
        levelButton.setNonserializable();
        buttons.add(levelButton);

        GameObject Left = new GameObject("LeftArrow", new Transform(new Pair(70, 332)), 6);
        ...
        GameObject Right = new GameObject("RightArrow", new Transform(new Pair(1150, 332)), 6);
